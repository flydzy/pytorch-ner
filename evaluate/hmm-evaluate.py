...
hmm.train(origin_dataset['train'][0], origin_dataset['train'][1], word2ids, tag2ids)
...
valid_pred_list = hmm.test(origin_dataset['valid'][0],word2id=word2ids, tag2id=tag2ids)
print("Valid Score:")
print(accuracy(valid_pred_list, origin_dataset['valid'][1]))


test_pred_list = hmm.test(origin_dataset['test'][0],word2id=word2ids, tag2id=tag2ids)
print("Test Score:")
